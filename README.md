...
# Portfolio with Nuxt and Strapi (Headless CMS)
...
```
```
Strapi directory => yarn develop
```
```
Nuxt directory => yarn dev
```
...
[<img alt="NuxtJS" width="30px" src="https://static-00.iconduck.com/assets.00/strapi-icon-512x505-3hl7a1v3.png" />][webdevplaylist]
[<img alt="Strapi" width="30px" src="https://seeklogo.com/images/N/nuxt-logo-1CCC5F38FD-seeklogo.com.png" />][webdevplaylist]
